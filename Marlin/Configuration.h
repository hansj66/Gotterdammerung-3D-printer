...
#define CUSTOM_MENDEL_NAME "'dammerung"
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -5.0
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {71.7087,39.8685,1238.94,52.25}  // default steps per unit for Ultimaker
#define DEFAULT_AXIS_STEPS_PER_UNIT   {71.7087,35.8543,1238.94,52.25}
#define DEFAULT_MAX_FEEDRATE          {200, 200, 5, 2000}    // (mm/sec)
//#define DEFAULT_MAX_ACCELERATION      {3000,3000,1,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
//#define DEFAULT_ACCELERATION          3000    // X, Y, Z and E max acceleration in mm/s^2 for printing moves
//#define DEFAULT_RETRACT_ACCELERATION  3000   // X, Y, Z and E max acceleration in mm/s^2 for retracts

#define DEFAULT_MAX_ACCELERATION      {4000,4000,1,4000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
